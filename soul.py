...
TOKEN = '7347025573:AAHnjUuzMZ1NQ1NYqub5v95vPZTQTe0FnAY'
...
def is_user_admin(user_id, chat_id):
    try:
        return bot.get_chat_member(chat_id, user_id).status in ['715186742', '715186742']
    except:
        return False
...
def handle_message(message):
    if message.text == "Instant Plan 🧡":
        ...
        bot.send_message(message.chat.id, "*Please use the following link for Canary Download: https://t.me/koina1997*", parse_mode='Markdown')
